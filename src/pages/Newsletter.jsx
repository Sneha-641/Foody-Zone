  ...
  return (
    <div className="mx-auto lg:px-28 py-12 md:px-12 px-4" style={{backgroundImage: `url(${A2})`}} id="contact">
      <div className="flex md:flex-row flex-col ">
        ...
        <div className="w-full md:w-1/2 text-center p-8"  style={{
        backgroundImage: `url(${A1})`}}>
            <h3 className="text-2xl md:text-3xl font-bold p-2">Subscribe to Our Newsletter</h3>
            <p className="text-sm p-2 md:text-lg ">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
